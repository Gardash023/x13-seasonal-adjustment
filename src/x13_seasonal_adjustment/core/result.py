...
class SeasonalAdjustmentResult:
    ...
    def plot(self, figsize: tuple = (12, 10), save_path: Optional[str] = None) -> None:
        ...
        axes[0].plot(
            self.seasonally_adjusted.index,
            self.seasonally_adjusted,
        ...
        # Trend
        axes[1].plot(
            self.trend.index, self.trend, label="Trend", color="green", linewidth=2
        )
        ...
        # Mevsimsel faktörler
        axes[2].plot(
            self.seasonal_factors.index,
            self.seasonal_factors,
            label="Mevsimsel Faktörler",
            color="orange",
        )
        ...
        # Düzensiz bileşen
        axes[3].plot(
            self.irregular.index,
            self.irregular,
            label="Düzensiz Bileşen",
            color="purple",
            alpha=0.6,
        )
